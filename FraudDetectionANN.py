...
synthetic_data_size_1 = int(len(dataset.index) * sample_size) - len(dataset_frauded_1)

gaussian_model = GaussianCopula()
gaussian_model.fit(dataset_frauded_1)
dataset_frauded_1_synthetic_data = gaussian_model.sample(synthetic_data_size_1)

dataset_frauded_1 = pd.concat([dataset_frauded_1, dataset_frauded_1_synthetic_data])
